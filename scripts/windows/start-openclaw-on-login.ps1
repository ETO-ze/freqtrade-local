...
powershell -ExecutionPolicy Bypass -File (Join-Path $scriptRoot 'start-openclaw-factor-daemon-stable.ps1')
Start-Sleep -Seconds 3
powershell -ExecutionPolicy Bypass -File (Join-Path $scriptRoot 'start-openclaw-factor-daemon-fast.ps1')
Start-Sleep -Seconds 3
powershell -ExecutionPolicy Bypass -File (Join-Path $scriptRoot 'start-openclaw-factor-daemon-autotune.ps1')
