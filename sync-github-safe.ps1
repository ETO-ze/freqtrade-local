...
$secretHits = (& git -C $ProjectRoot diff --cached -U0 -- . ":(exclude)sync-github-safe.ps1" | Select-String -Pattern "github_pat_|ghp_[A-Za-z0-9_]{20,}|sk-proj-[A-Za-z0-9_-]{20,}|sk-[A-Za-z0-9]{32,}|xox[baprs]-[A-Za-z0-9-]{20,}" -AllMatches)
if ($secretHits) {
    Invoke-Git @("reset", "--")
